...
#define AIO_KEY         "aio_vudS80YDYBXdUXY1wg7FXT1uqT6b"
...
const int lightpin=D0;   //D0 if you don't have external led
const int servopin=D8; //D8 if you don't have external leds
...
void servocallback(char *data, uint16_t len) {
  int pos= int(*data);
  Serial.println("Servo Pos: "+pos);
   myservo.write(pos); 
}
void setup() {
  Serial.begin(115200);
